...
public class ModuleLifecycleTest
{
	...
	public void allModulesStartUpAndShutDownCleanly()
	{
		...
		Set<IronHubModule> modules = new IronHubPlugin().provideModules(
			...
			new FarmingRunModule(state, null, new net.runelite.client.eventbus.EventBus(), null, null, null, config, null, new com.ironhub.data.DataPack(new com.google.gson.Gson())),
