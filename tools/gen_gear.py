...
phases = [
  {'phase': 1, 'name': 'Early game', 'groups': [
    ...
    G('[L1] Foundations',
      I("Amulet of strength", 'AMULET_OF_STRENGTH', ['melee']),
    ...
    G('Phase 1 utility',
      ...
      I("Coal bag", 'COAL_BAG_12019', ['utility']),
      I("Gem bag", 'GEM_BAG_12020', ['utility']),
    ),
  ]},
  {'phase': 2, 'name': 'Mid game', 'groups': [
    ...
    G('Moons of Peril',
      ...
      I("Amulet of glory", 'AMULET_OF_GLORY', ['utility']),
    ),
    ...
    G('[L10-15] The slayer on-ramp',
      ...
      I("Pharaoh's sceptre", 'PHARAOHS_SCEPTRE', ['utility'], [], "Pharaoh's_sceptre"),
    ...
    G('Royal Titans',
      ...
      I("Hunters' sunlight crossbow", 'HUNTERS_SUNLIGHT_CROSSBOW', ['ranged'], ['skill:Ranged:66', 'skill:Fletching:69'], "Hunters'_sunlight_crossbow"),
    ...
    G('Convenience grinds',
      I("Fish barrel", 'FISH_BARREL', ['utility']),
      I("Tackle box", 'TACKLE_BOX', ['utility']),
      I("Gem sack", 'GEM_SACK', ['utility'], implies=['Gem bag']),
      I("Plank sack", 'PLANK_SACK', ['utility']),
      I("Amy's saw", 'AMYS_SAW', ['utility'], [], "Amy's_saw"),
      I("Seed box", 'SEED_BOX', ['utility']),
      I("Herb sack", 'HERB_SACK', ['utility']),
      I("Divine rune pouch", 'DIVINE_RUNE_POUCH', ['utility'], ['skill:Crafting:75'], implies=['Rune pouch']),
      I("Fletching knife", 'FLETCHING_KNIFE', ['utility']),
      I("Basic quetzal whistle", 'BASIC_QUETZAL_WHISTLE', ['utility']),
      I("Pendant of Ates", 'PENDANT_OF_ATES', ['utility'], [], 'Pendant_of_Ates'),
      I("Huntsman's kit", 'HUNTSMANS_KIT', ['utility'], [], "Huntsman's_kit"),
      I("Costume needle", 'COSTUME_NEEDLE', ['utility'], ['quest:Death on the Isle']),
      I("Bottomless compost bucket", 'BOTTOMLESS_COMPOST_BUCKET', ['utility']),
      I("Ash covered tome", 'ASH_COVERED_TOME', ['utility']),
    ),
  ]},
  {'phase': 3, 'name': 'Late game', 'groups': [
    ...
    G('[L21-25] Post-Gauntlet consolidation',
      I("Amulet of fury", 'AMULET_OF_FURY', ['melee', 'ranged', 'magic'], ['skill:Crafting:85', 'skill:Magic:82']),
    ...
    G('[L27-30] Voidwaker, prayers, ToA dip',
      ...
      I("Lightbearer", 'LIGHTBEARER', ['utility']),
    ...
    G('[L36-39] Zulrah to Rigour & Augury',
      ...
      I("Serpentine helm", 'SERPENTINE_HELM', ['melee', 'ranged'], ['kc:Zulrah:1', 'skill:Defence:75']),
      I("Osmumten's fang", 'OSMUMTENS_FANG', ['melee'], ['skill:Attack:82'], "Osmumten's_fang"),
    ...
    G('Phase 3 utility',
      ...
      I("Neitiznot faceguard", 'NEITIZNOT_FACEGUARD', ['melee'], ['quest:The Fremennik Exiles', 'skill:Defence:70'], implies=['Helm of Neitiznot']),
    ),
  ]},
  {'phase': 4, 'name': 'Endgame & megarares', 'groups': [
    ...
    G('[L44-49] The megarare trio',
      ...
      I("Tumeken's shadow", 'TUMEKENS_SHADOW', ['magic'], ['skill:Magic:85'], "Tumeken's_shadow"),
      ...
      I("Masori mask (f)", 'MASORI_MASK_F', ['ranged'], ['skill:Ranged:80', 'skill:Defence:80'], 'Masori_armour'),
      I("Masori body (f)", 'MASORI_BODY_F', ['ranged'], ['skill:Ranged:80', 'skill:Defence:80'], 'Masori_armour'),
      I("Masori chaps (f)", 'MASORI_CHAPS_F', ['ranged'], ['skill:Ranged:80', 'skill:Defence:80'], 'Masori_armour'),
      I("Elidinis' ward (f)", 'ELIDINIS_WARD_F', ['magic'], ['skill:Magic:80', 'skill:Defence:80', 'skill:Prayer:80'], "Elidinis'_ward"),
