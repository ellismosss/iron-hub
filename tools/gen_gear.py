...
phases = [
  ...
  {'phase': 2, 'name': 'Mid game', 'groups': [
    ...
    G('[L16-19] Void and the chinning ramp',
      ...
      I("Elite void top", 'ELITE_VOID_TOP', ['ranged', 'magic'], ['Hard Western Provinces diary', 'skill:Prayer:22', 'skill:Attack:42', 'skill:Strength:42', 'skill:Defence:42', 'skill:Hitpoints:42', 'skill:Ranged:42', 'skill:Magic:42', 'item:8839:1:Void knight top'], 'Elite_Void_Knight_equipment', implies=['Void knight top']),
  ...
  {'phase': 3, 'name': 'Late game', 'groups': [
    ...
    G('[L21-25] Post-Gauntlet consolidation',
      ...
      I("Ava's assembler", 'AVAS_ASSEMBLER', ['ranged'], ['quest:Dragon Slayer II', 'kc:Vorkath:1', 'skill:Ranged:70', "item:10499:1:Ava's accumulator"], "Ava's_assembler", implies=["Ava's accumulator"]),
